...
class PipelineStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs):
        ...
        github_repo = 'johnquintal/aws-cdk-pipelines-demo'
        ...
        lambda_function1 = ApplicationStageLambda1(
            self, 'Container-CDK-Pipeline-Lambda-Stage1')
        lambda_function_stage1 = pipeline.add_stage(
            lambda_function1, pre=[buildContainerProject])
